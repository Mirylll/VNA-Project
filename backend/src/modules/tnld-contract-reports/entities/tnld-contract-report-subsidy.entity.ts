...
@Entity('tnld_contract_report_subsidies')
export class TnldContractReportSubsidy {
  ...
  @OneToOne(() => TnldContractReport, (report) => report.subsidy, { onDelete: 'CASCADE' })
  ...
  @Column({ name: 'total_cost', type: 'numeric', precision: 18, scale: 2, default: 0 })
  totalCost: string;
